...
@push('styles')
  ...
  <link rel="stylesheet" href="{{ asset('asset/css/about/sister-concern.css') }}">
@endpush
@section('content')
  ...
  <section class="container my-5 brand-text-color">
    <h3 class="sister-about-heading">About MSRL</h3>
    @if($sis && $sis->about_us)
  ...
  @if($sis && ($sis->image_1 || $sis->image_2))
    <section class="container mb-5">
      <div class="row g-4 sister-gallery-row">
        @if($sis->image_1)
          <div class="col-md-6 sister-gallery-col">
            <div class="sister-gallery-card">
              <img src="{{ asset('uploads/sisterConcern/' . $sis->image_1) }}" alt="MSRL ship recycling">
            </div>
          </div>
        @endif
        @if($sis->image_2)
          <div class="col-md-6 sister-gallery-col">
            <div class="sister-gallery-card">
              <img src="{{ asset('uploads/sisterConcern/' . $sis->image_2) }}" alt="MSRL yard operations">
            </div>
          </div>
        @endif
      </div>
