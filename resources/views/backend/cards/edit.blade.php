                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title_1" class="form-control" name="title_1" value="{{ old('title_1', $data->title_1)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title_2" class="form-control" name="title_2" value="{{ old('title_2', $data->title_2)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title_3" class="form-control" name="title_3" value="{{ old('title_3', $data->title_3)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title_4" class="form-control" name="title_4" value="{{ old('title_4', $data->title_4)}}">
                                ...
                                <div class="form-group">
                                    <label for="short_description">Description <i class="text-danger">*</i></label>
                                     <textarea name="short_description" cols="30" rows="8" id="short_description" class="form-control">{{ old('short_description', $data->short_description)}}</textarea>
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="number_1" class="form-control" name="number_1" value="{{ old('number_1', $data->number_1)}}">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="number_2" class="form-control" name="number_2" value="{{ old('number_2', $data->number_2)}}">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="number_3" class="form-control" name="number_3" value="{{ old('number_3', $data->number_3)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="number_4" class="form-control" name="number_4" value="{{ old('number_4', $data->number_4)}}">
