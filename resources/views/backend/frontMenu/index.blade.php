...
@section('content')
    ...
    $menu_lnk = array(
                                    ...
                                    <div class="widget-content padding">
                                        <div class="widget-content padding">
                                            <a class="btn btn-info" href="javascript:void(0);"
                                                onclick=" $('.reset').click(); $('.insertion_div').toggle();$('[name=id]').val(0);">
                                                <i class="fa fa-plus" aria-hidden="true"></i>Add New Menu
                                            </a>
                                            <hr />
                                            <div class="insertion_div">
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item"><a class="nav-link link active"
                                                            data-bs-toggle="tab" href="#link">From List</a></li>
                                                    <li class="nav-item"><a class="nav-link page" data-bs-toggle="tab"
                                                            href="#page">From Page</a></li>
                                                </ul>
                                                <div class="tab-content pt-3">
                                                    <div id="link" class="tab-pane container active">
                                                        <form class="menu_form" enctype="multipart/form-data"
                                                            action="{{route('front_menu.save')}}" method="POST">
                                                            @csrf
        ...
        foreach ($menu_lnk as $k => $v) { ?>
                                                            ...
                                                            <div class="form-group">
                                                                <button type="submit"
                                                                    class="btn btn-primary btn-label-left">Save</button>
                                                                <button type="reset"
                                                                    class="reset btn btn-warning">Reset</button>
                                                                <button type="button" class="btn btn-danger pull-right"
                                                                    onclick="$('.insertion_div').hide();">Close</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <div id="page" class="tab-pane container fade">
                                                        <form class="menu_form" action="{{route('front_menu.save')}}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label>Menu Name</label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="href">
                                                                    ...
                                                                    <?php if ($pages) {
        foreach ($pages as $mp) { ?>
                                                                    <option value="page/<?= $mp['page_slug'] ?>">
                                                                        <?= $mp['page_title'] ?>
                                                                    </option>
                                                                    <?php    }
    } ?>
