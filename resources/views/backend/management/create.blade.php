                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="top_management_title" class="form-control" name="top_management_title" value="{{ old('top_management_title')}}" placeholder="Enter Title" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5" id="top_description" name="top_description"></textarea>
                            ...
                            <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="mid_management_title" class="form-control" name="mid_management_title" value="{{ old('mid_management_title')}}" placeholder="Enter Title" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5" id="mid_description" name="mid_description"></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="yard_management_title" class="form-control" name="yard_management_title" value="{{ old('yard_management_title')}}" placeholder="Enter Title">
