    ...
    <div class="page-content">
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('top.update', encryptor('encrypt',$data->id)) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                               ...
                               <img src="{{asset('uploads/topManagement/'.$data->image)}}" alt="Management" width="250px">
                            </div>
                        </div>
